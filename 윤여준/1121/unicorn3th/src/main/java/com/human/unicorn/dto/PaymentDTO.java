...
public class PaymentDTO {
	...
	public Date getSigupdate() {
		return sigupdate;
	}
	public void setSigupdate(Date sigupdate) {
	...
	public String toString() {
		return "PaymentDTO [userno=" + userno + ", id=" + id + ", name=" + name + ", address=" + address
				...
				+ ", userpoint=" + userpoint + ", grade=" + grade + ", sigupdate=" + sigupdate + ", productno="
				+ productno + ", productname=" + productname + ", productex=" + productex + ", mainimg1=" + mainimg1
				+ ", mainimg2=" + mainimg2 + ", mainimg3=" + mainimg3 + ", fabric=" + fabric + ", company=" + company
				+ ", popularity=" + popularity + ", productprice=" + productprice + "]";
	}
