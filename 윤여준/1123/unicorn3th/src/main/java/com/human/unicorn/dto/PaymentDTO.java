...
public class PaymentDTO {
	...
	public String toString() {
		return "PaymentDTO [id=" + id + ", name=" + name + ", address=" + address + ", addressdetails=" + addressdetails
				...
				+ orderquantity + ", orderaddress=" + orderaddress + ", orderstatus=" + orderstatus + ", invoiceno="
				+ invoiceno + ", totalprice=" + totalprice + ", message=" + message + ", deliveryfee=" + deliveryfee
				+ ", paymentno=" + paymentno + "]";
	}
	...
	public int getDelveryFee() {
		return deliveryFee;
	}
	public void setDelveryFee(int deliveryFee) {
