...
/* =========================
 ...
 right: 10px; transform: translateY(-50%); padding: 10px; border-radius: 10px; margin-right: 10px;
  ...
  .top-button img, .bottom-button img { width: 160%; /* 이미지가 버튼에 꽉 차게 표시 */ }
        ...
        <input type="radio" id="5-stars" name="rating" value="5" ${reviewList.reviewrates == 5 ? 'checked' : ''} />
        <label for="5-stars" class="star">&#9733;</label>
        <input type="radio" id="4-stars" name="rating" value="4" ${reviewList.reviewrates == 4 ? 'checked' : ''} />
        <label for="4-stars" class="star">&#9733;</label>
        <input type="radio" id="3-stars" name="rating" value="3" ${reviewList.reviewrates == 3 ? 'checked' : ''} />
        <label for="3-stars" class="star">&#9733;</label>
        <input type="radio" id="2-stars" name="rating" value="2" ${reviewList.reviewrates == 2 ? 'checked' : ''} />
        <label for="2-stars" class="star">&#9733;</label>
        <input type="radio" id="1-star" name="rating" value="1" ${reviewList.reviewrates == 1 ? 'checked' : ''} />
              ...
              <div class="textreview">
                ...
                <textarea placeholder="다른 고객님에게 도움이 되도록 상품에 대한 솔직한 평가를 남겨주세요" class="textareareview">
                ${reviewList.reviewdetails }</textarea>
             </div>
