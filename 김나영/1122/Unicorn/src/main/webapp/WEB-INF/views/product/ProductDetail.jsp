	...
	<section id="section" class="sectionbody">
		...
		<div class="bigbox">
			...
			<div class="box1">
				<div class="imgg">
					<div class="big-img">
						<img id="bigImage" src="${productDetailValue[0].mainImg1}" alt="">
					</div>

					<div class="small-img">
						<div class="small1 small-image"
							onmouseover="changeImage('bigImage', '${productDetailValue[0].mainImg1}')">
							<img src="${productDetailValue[0].mainImg1}" alt="">
						</div>

						<div class="small2 small-image"
							onmouseover="changeImage('bigImage', '${productDetailValue[0].mainImg2}')">
							<img src="${productDetailValue[0].mainImg2}" alt="">
						</div>
						<div class="small3 small-image"
							onmouseover="changeImage('bigImage', '${productDetailValue[0].mainImg3}')">
							<img src="${productDetailValue[0].mainImg3}" alt="">
						</div>
			...
			<div class="box2">
				<div class="Product-option">
					...
					<form action="shopping_basketServlet">
						<div class="name mb-3">       ${productDetailValue.productName}</div>
						
						<div class="price mb-2">"${ProductDetailList.price}"</div>
			...
			<div class="tab-content">
				<div class="tab-pane container active" id="home">
					<div class="titleArea">
						...
						<div class="infoimg">
							<div>
								<img src="${ProductDetailDTO.img}" alt="" style="width: 100%;">
							</div>
							<br>
							<div>
								<img src="${ProductDetailDTO.img}" alt=""
									style="width: 100%;">
