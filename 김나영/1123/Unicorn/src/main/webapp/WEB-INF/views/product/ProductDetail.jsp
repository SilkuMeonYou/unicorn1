			...
			<div class="box2">
				<div class="Product-option">
					...
					<form action="shopping_basketServlet">
						...
						<select class="form-select" id="size-select" name="productSize" onchange="updateTotalPrice()">
    <option value="${productOptions[0].productSize}" data-price="${productOptions[0].price}" selected>${productOptions[0].productSize}</option>
    <option value="${productOptions[1].productSize}" data-price="${productOptions[1].price}">${productOptions[1].productSize}</option>
    <option value="${productOptions[2].productSize}" data-price="${productOptions[2].price}">${productOptions[2].productSize}</option>
    <option value="${productOptions[3].productSize}" data-price="${productOptions[3].price}">${productOptions[3].productSize}</option>
</select>
				...
				<div class="quantity-selection">
					...
					<h5 style="text-align: right; margin-right: 20px;">
						<br>총 결제금액 : <span id="total-price">0원</span>
