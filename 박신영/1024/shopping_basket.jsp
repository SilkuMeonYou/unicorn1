...
<%
session.setAttribute("pdPrice", "1,550,000");
session.setAttribute("deliveryPrice", "0");
session.setAttribute("dcPrice", "100,000");
%>
			...
			<div class="sectionContainer">
				...
				<div class="infoContainer" id="infoContainer1">
					<table width="100%" class="orderTable">
						...
						<tr>
							...
							<td colspan="6" class="orderHead" id="order_title">Bello
								edition</td>
							<td><button class="removeButton" id="removeBtn1">삭제</button></td>
						</tr>

						<tr>
							<td rowspan="2"><label class="custom-checkbox" for="chkbox1">
									<input type="checkbox" id="chkbox1"> <span
						...
						<tr>
							<td class="orderDetails"><select class="sizeBox" id="size1">
							...
							<td class="orderDetails" id="order_amount">
								<button class="amountNum" id="minus1">-</button> <span
								id="orderAmount1">1</span>
								<button class="amountNum" id="plus1">+</button>

							</td>
							<td class="orderDetails" id="order_fee1"><%=session.getAttribute("pdPrice")%></td>
							<td class="orderDetails" id="order_deliveryFee1"><%=session.getAttribute("deliveryPrice")%></td>
							<td class="orderDetails" id="order_discountFee1"><%=session.getAttribute("dcPrice")%></td>
				...
				<div class="infoContainer" id="infoContainer2">
					<table width="100%" class="orderTable">
						...
						<tr>
							<td rowspan="2"><label class="custom-checkbox" for="chkbox2">
									<input type="checkbox" id="chkbox2"> <span
									class="checkmark"></span>
							</label></td>
							<td rowspan="2"><img
						...
						<tr>
							<td class="orderDetails"><select class="sizeBox" id="size2">
							...
							<td class="orderDetails" id="order_amount">
								<button class="amountNum" id="minus2">-</button> <span
								id="orderAmount2">1</span>
