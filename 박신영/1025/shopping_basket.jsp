...
<%@ page import="shopping_basket.Cart"%>
		...
		<div class="sectionContainer">
			...
			if (cartList != null && list != null) {
				...
				for (Cart cart : cartList) {
					ProductInfo info = list.get(cart.getNum());
			%>
			...
			<div class="infoContainer" id="infoContainer<%=count%>">
				<table width="100%" class="orderTable">
					...
					<tr>
						...
						<td><button class="removeButton" id="removeBtn<%=count%>">삭제</button></td>
					</tr>
		...
		<div class="totalContainer">
			<table width="100%">
				...
				<tr>
					...
					<td rowspan="2" class="operator">=</td>
					<td>총 주문금액</td>
					<td rowspan="2"><button class="orderButton"><a href="payment.jsp">주문하기</a></button></td>
				</tr>
