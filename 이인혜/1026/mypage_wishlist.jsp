      ...
      <div class="mainbar2">
        <div class="menubar">
          <ul>
			...
			<li class="menubar_item"><a href="mypage_orderlist.jsp">주문내역조회</a></li>
			<li class="menubar_item"><a href="mypage_point.jsp">적립금내역</a></li>
			<li class="menubar_item"><a href="mypage_coupon.jsp">쿠폰내역</a></li>
			</ul>
			<ul>
        ...
        <div class="wishlist">
         ...
         List<ProductInfo> wishlist = (List<ProductInfo>)request.getAttribute("wishlist"); 
         for (ProductInfo productInfo : wishlist){
        	%>
