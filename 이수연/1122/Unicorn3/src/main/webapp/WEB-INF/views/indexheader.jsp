...
<body class="main" style="margin-top: 0;">
	...
	<div id="wrap">
			...
			<div class="toparea">
				...
				<c:choose>
						...
						<ul class="topbar">
							...
							<li class="top-item"><a href="#" class="top-link"><Strong>${list.name }</Strong>&nbsp;
									님</a>&nbsp; 환영합니다</li>
						</ul>
				...
				<div class="container-fluid">
					...
					<div class="collapse navbar-collapse" id="navbarNavAltMarkup">
						...
						<div class="navbar-nav ms-5 hstack gap-4">
							<a class="nav-link active" aria-current="page" href="index.jsp"><h6>
									Home</h6></a> <a class="nav-link" href="event.jsp"><h6>Event</h6></a> <a
								class="nav-link" href="pdlisttest"><h6>Best</h6></a> <a
								class="nav-link" href="pdlisttest"><h6>Product</h6></a>
							<div class="vr"></div>
		...
		<section id="section" class="sectionbody">
			<div class="sectionwrap" id=sectionwrap></div>
</body>
